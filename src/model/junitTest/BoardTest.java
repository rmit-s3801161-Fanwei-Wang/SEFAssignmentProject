...
public class BoardTest {
    ...
    @Test
    public void testLevel1() throws GridsBeingTakenException, OutOfBoardException, OnlyOneSnakeGreaterEightyException {
        board.viewBoard();
        Dice dice = new Dice();
        for (int j = 0; j < 4; j++) {
            int m = dice.rollDice();
    ...
    public void testLevel3() throws InitializeException {
        ...
        } catch (OutOfBoardException | OnlyOneSnakeGreaterEightyException e) {
            e.printStackTrace();
